...
final readonly class RefundVerifyRequest implements JsonSerializable
{
    ...
    public function __construct(
        public ?Reference   $reference = null,      // host refund reference
        public ?ProviderRef $providerRef = null,  // provider refund id/ref
        ?Metadata           $meta = null,
